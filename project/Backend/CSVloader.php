...
$sql = "CREATE DATABASE IF NOT EXISTS comp353Project";
if ($conn->query($sql) === TRUE) {
    echo "comp353Project database created successfully";
} else {
    echo "Error creating comp353Project database: " . $conn->error;
}

// Creating tables if doesn't exist 

$conn->select_db('comp353Project');
